...
export default class ProtocolHandlerJSCheck {
  ...
  match(astNode) {
    const methods = ['setAsDefaultProtocolClient', 'registerStandardSchemes', 'registerServiceWorkerSchemes', 'registerFileProtocol', 'registerHttpProtocol', 'registerStringProtocol', 'registerBufferProtocol', 'registerStreamProtocol'];
...
//# sourceMappingURL=ProtocolHandlersJSCheck.js.map