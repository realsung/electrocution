...
export default class ContextIsolationJSCheck {
  ...
  match(astNode, astHelper, scope) {
    ...
    if (astNode.arguments.length > 0) {
      ...
      const contextIsolation = astHelper.findNodeByType(target, astHelper.PropertyName, astHelper.PropertyDepth, false, node => node.key.value === 'contextIsolation' || node.key.name === 'contextIsolation');
...
//# sourceMappingURL=ContextIsolationJSCheck.js.map