...
export default class AuxclickJSCheck {
  ...
  match(astNode, astHelper, scope) {
    ...
    if (astNode.arguments.length > 0) {
      ...
      const found_nodes = astHelper.findNodeByType(target, astHelper.PropertyName, astHelper.PropertyDepth, false, node => node.key.value === 'disableBlinkFeatures' || node.key.name === 'disableBlinkFeatures');
...
//# sourceMappingURL=AuxclickJSCheck.js.map