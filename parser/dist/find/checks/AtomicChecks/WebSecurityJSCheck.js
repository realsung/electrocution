...
export default class WebSecurityJSCheck {
  ...
  match(astNode, astHelper, scope) {
    ...
    if (astNode.arguments.length > 0) {
      ...
      const found_nodes = astHelper.findNodeByType(target, astHelper.PropertyName, astHelper.PropertyDepth, false, node => node.key.value === 'webSecurity' || node.key.name === 'webSecurity');
...
//# sourceMappingURL=WebSecurityJSCheck.js.map