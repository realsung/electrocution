  ...
  match(astNode, astHelper, scope) {
    ...
    if (astNode.arguments.length > 0) {
      if (astNode.arguments.length > 1) {
        ...
        const found_nodes = astHelper.findNodeByType(astNode.arguments[1], astHelper.PropertyName, astHelper.PropertyDepth, false, node => node.key.name === 'visibleOnFullScreen');
...
//# sourceMappingURL=VisibleOnFullScreen.js.map