  ...
  match(astNode, astHelper) {
    ...
    switch (astNode.arguments[0].type) {
      case astHelper.StringLiteral:
        if (!astNode.arguments[0].value.trim().toUpperCase().startsWith("HTTP://")) return undefined;
        break;
      case "TemplateLiteral":
        if (astNode.arguments[0].type !== "TemplateLiteral" || astNode.arguments[0].quasis[0].type !== "TemplateElement" || !astNode.arguments[0].quasis[0].value.cooked.trim().toUpperCase().startsWith("HTTP://")) return undefined;
        break;
      default:
        return undefined;
    }
...
//# sourceMappingURL=HTTPResourcesJSCheck.js.map