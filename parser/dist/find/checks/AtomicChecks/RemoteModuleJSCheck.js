...
export default class RemoteModuleJSCheck {
  ...
  match(astNode, astHelper, scope, defaults) {
    ...
    if (astNode.arguments.length > 0) {
      ...
      const found_nodes = astHelper.findNodeByType(target, astHelper.PropertyName, astHelper.PropertyDepth, false, node => node.key.value === 'enableRemoteModule' || node.key.name === 'enableRemoteModule');
    ...
    if (wasFound) {
      return loc;
    } else if (defaults.enableRemoteModule) {
...
//# sourceMappingURL=RemoteModuleJSCheck.js.map