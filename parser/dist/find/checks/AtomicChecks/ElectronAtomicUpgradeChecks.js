...
const ELECTRON_ATOMIC_UPGRADE_CHECKS = {
  5: [BrowserWindowWebPreferences, NativeWindowOpen, PrivilegedSchemesRegistrationRemoval, SetSpellCheckProviderDeprecation, WebFrameIsolatedWorldDeprecation],
  6: [ContentTracingGetTraceBufferUsage, EnableMixedSandboxDeprecation, QuerySystemIdleStateDeprecation, QuerySystemIdleTimeDeprecation, RequireElectronScreen, RequireSandboxedRenderers, SetNullMenuDeprecation, SetHighlightModeDeprecation],
  7: [ClearAuthCache, ContentTracingGetTraceBufferUsageRemoval, EnableMixedSandboxRemoval, QuerySystemIdleState, QuerySystemIdleTime, SetHighlightModeRemoval, WebFrameIsolatedWorldRemoval, WebKitDirectoryChange],
  8: [AllowRendererProcessReuse, GetColor, GetWebContents, IPCSend, SetLayoutZoomLevelLimits, VisibleOnFullScreen]
};

module.exports.ELECTRON_ATOMIC_UPGRADE_CHECKS = ELECTRON_ATOMIC_UPGRADE_CHECKS;
//# sourceMappingURL=ElectronAtomicUpgradeChecks.js.map