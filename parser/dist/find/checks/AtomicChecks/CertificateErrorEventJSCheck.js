...
export default class CertificateErrorEventJSCheck {
  ...
  match(astNode) {
    if (!(astNode.type === 'CallExpression' && astNode.callee.property && astNode.callee.property.name === 'on' && astNode.arguments[0] && astNode.arguments[0].value === 'certificate-error')) {
      return null;
    }
...
//# sourceMappingURL=CertificateErrorEventJSCheck.js.map