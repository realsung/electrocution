...
export default class WebFrameIsolatedWorldDeprecation {
  ...
  match(astNode, astHelper, scope) {
    ...
    if (!astNode.callee.property || astNode.callee.property.name !== 'setIsolatedWorldContentSecurityPolicy' && astNode.callee.property.name !== 'setIsolatedWorldHumanReadableName' && astNode.callee.property.name !== 'setIsolatedWorldSecurityOrigin') {
      return null;
    }
...
//# sourceMappingURL=WebFrameIsolatedWorldDeprecation.js.map