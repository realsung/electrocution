...
export default class NativeWindowOpen {
  ...
  match(astNode, astHelper, scope) {
    ...
    if (astNode.arguments.length > 0) {
      ...
      const found_nodes = astHelper.findNodeByType(target, astHelper.PropertyName, astHelper.PropertyDepth, false, node => node.key.value === 'nativeWindowOpen' || node.key.name === 'nativeWindowOpen');
...
//# sourceMappingURL=NativeWindowOpen.js.map