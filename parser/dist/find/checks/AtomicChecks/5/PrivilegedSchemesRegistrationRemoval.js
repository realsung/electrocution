...
export default class PrivilegedSchemesRegistrationRemoval {
  ...
  match(astNode, astHelper, scope) {
    ...
    if (!astNode.callee.property || astNode.callee.property.name !== 'registerURLSchemeAsPrivileged' && astNode.callee.property.name !== 'registerURLSchemeAsBypassingCSP' && astNode.callee.property.name !== 'registerStandardSchemes') {
      return null;
    }
...
//# sourceMappingURL=PrivilegedSchemesRegistrationRemoval.js.map