...
export default class BlinkFeaturesJSCheck {
  ...
  match(astNode, astHelper, scope) {
    ...
    if (astNode.arguments.length > 0) {
      ...
      const found_nodes = astHelper.findNodeByType(target, astHelper.PropertyName, astHelper.PropertyDepth, false,
      ...
      node => node.key.value === 'enableBlinkFeatures' || node.key.name === 'enableBlinkFeatures' || node.key.value === 'blinkFeatures' || node.key.name === 'blinkFeatures');
...
//# sourceMappingURL=BlinkFeaturesJSCheck.js.map