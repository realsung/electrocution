...
export default class SandboxJSCheck {
  ...
  match(astNode, astHelper, scope) {
    ...
    if (astNode.arguments.length > 0) {
      ...
      const found_nodes = astHelper.findNodeByType(target, astHelper.PropertyName, astHelper.PropertyDepth, false, node => node.key.value === 'sandbox' || node.key.name === 'sandbox');
...
//# sourceMappingURL=SandboxJSCheck.js.map