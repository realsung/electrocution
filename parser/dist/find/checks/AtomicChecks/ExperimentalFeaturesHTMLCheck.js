  ...
  match(cheerioObj, content) {
    ...
    webviews.each(function (i, elem) {
      ...
      if (wp) {
        ...
        if (features['experimentalFeatures'] === true || features['experimentalCanvasFeatures'] === true) loc.push({ line: content.substr(0, elem.startIndex).split('\n').length, column: 0, id: self.id, description: self.description, shortenedURL: self.shortenedURL, severity: severity.LOW, confidence: confidence.CERTAIN, manualReview: false });
      }
    });
    return loc;
  }
}
//# sourceMappingURL=ExperimentalFeaturesHTMLCheck.js.map