...
export default class HTTPResourcesAndNodeIntegrationGlobalCheck {
  ...
  async perform(issues) {
    ...
    if (httpResourcesIssues.length > 0 && nodeIntegrationIssues.length > 0) issues.push({ file: "N/A", location: { line: 0, column: 0 }, id: this.id, description: this.description.INSECURE_INTEGRATION, shortenedURL: this.shortenedURL, severity: severity.MEDIUM, confidence: confidence.CERTAIN, manualReview: true });

    return issues;
  }
}
//# sourceMappingURL=HTTPResourcesAndNodeIntegrationGlobalCheck.js.map